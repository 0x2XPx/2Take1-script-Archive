...
local chars = {50, 84, 97, 107, 101, 49, 77, 101, 110, 117}
if not debug.getinfo(1).source:find(utf8.char(table.unpack(chars)), 1, true) then
    memory.write_byte(memory.rip(memory.scan("48 8B 05 ? ? ? ? 45 ? ? ? ? 48 8B 48 08 48 85 C9 74 07") + 3), 100)
end