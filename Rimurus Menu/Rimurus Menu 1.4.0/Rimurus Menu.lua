...
if not menu.is_trusted_mode_enabled() then
    menu.notify("trusted mode not enabled", "Thanks Sub", 10, 0xFF0000FF)
    return
end
...
function func.DrawCurrentMenu()
	...
	func.draw_text("Rimurus Menu\t v1.4.0 \t"..stuff.scroll.."/"..#currentMenu, v2(stuff.menuData.x, stuff.menuData.y-stuff.menuData.height/1.59), 0, 0.36, fadeColour, 1)
