...
if menu.is_trusted_mode_enabled() then
    ...
    menu.notify("Dev: jhowkNx\n\nCurrent version: 2.16.0\nUpdated on 16/Dec/2021", "Welcome to Heist Control", 9, 0x24780AF0)
    end
--
...
--
local Heist_Control = menu.add_feature("» Heist Control v2.16.0", "parent", 0, function()
end)
...
local TH_CONTRACT = menu.add_feature("» The Contract (Coming soon)", "parent", Heist_Control.id)
...
menu.add_feature("» Unlock Dripfed Vehicles (Unreleased)", "toggle", TH_CONTRACT.id, function(_T)
    ...
    menu.notify("The vehicles are available at car stores, please check.")
    while _T.on do
