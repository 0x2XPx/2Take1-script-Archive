...
if menu.is_trusted_mode_enabled() then
    menu.notify("Dev: jhowkNx\n\nCurrent version: v2.19.0\nUpdated on 23/Jan/2022", "Welcome to Heist Control", 7, 0x5014B4F0)
...
--
local Heist_Control = menu.add_feature("» Heist Control v2.19.0", "parent", 0, function()
end)
...
menu.add_feature("Ocean : Escape", "action", TELEPORT_QL.id, function()
    ...
    entity.set_entity_coords_no_offset(pedmy,v3(4327.866,-3920.418,-46.346))
...
local DD_H_ACT1 = {
    ...
    menu.add_feature("» ACT I : The Data Breaches [$2.5MI - All Players]", "toggle", DOOMS_PRESETS.id, function(ACT1_)
...
local DD_H_ACT2 = {
    ...
    menu.add_feature("» ACT II : The Bogdan Problem [$2.5MI - All Players]", "toggle", DOOMS_PRESETS.id, function(ACT2_)
...
local DD_H_ACT3 = {
    ...
    menu.add_feature("» ACT III : The Doomsday Scenario [$2.5MI - All Players]", "toggle", DOOMS_PRESETS.id, function(ACT3_)
...
menu.add_feature("» Modify Vehicle Top Speed", "action", TOOLS.id, function()
    ...
    local r, s = input.get("Enter a new Speed", "", 999999)
...
menu.add_feature("» Remove NPC weapons", "toggle", TOOLS.id, function(_RE)
    menu.notify("Don't leave it activated for too long, may it can cause some crashes", "", 5, 0x5014B4F0)
    while _RE.on do
