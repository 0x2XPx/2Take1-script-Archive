...
function copyOutfit(player_ped, clone_ped)
    local plyr_clothes = {
...
function randomTropicalOutfit(mp_ped)
    if (entity.get_entity_model_hash(mp_ped) == 2627665880) then
        ...
        if (math.random(0, 15) == 10) then
            ped.set_ped_component_variation(mp_ped, 3, 4, 0, 0) -- torsos
            ped.set_ped_component_variation(mp_ped, 11, 74, 0, 0)
            ped.set_ped_component_variation(mp_ped, 8, 2, 0, 0)
            ped.set_ped_component_variation(mp_ped, 7, 0, 0, 0)
        else
        ...
        if (math.random(0, 15) == 10) then
            ...
            ped.set_ped_component_variation(mp_ped, 8, 15, 0, 0)
            ped.set_ped_component_variation(mp_ped, 7, 0, 0, 0)
        else
            ped.set_ped_component_variation(mp_ped, 3, 0, 0, 0) -- torsos
            ped.set_ped_component_variation(mp_ped, 11, 260, math.random(0, 25), 0) -- tops
...
function randomGolferOutfit(mp_ped)
    if (entity.get_entity_model_hash(mp_ped) == 2627665880) then
        ped.set_ped_component_variation(mp_ped, 3, 14, 0, 0) -- torsos
        ped.set_ped_component_variation(mp_ped, 11, math.random(400, 401), math.random(0, 7), 0) -- tops
        ped.set_ped_component_variation(mp_ped, 4, 137, math.random(0, 15), 0) -- legs
        ped.set_ped_component_variation(mp_ped, 6, 103, math.random(0, 23), 0) -- feet
    else
        ped.set_ped_component_variation(mp_ped, 3, 0, 0, 0) -- torsos
        ped.set_ped_component_variation(mp_ped, 11, math.random(382, 383), math.random(0, 7), 0) -- tops
        ped.set_ped_component_variation(mp_ped, 4, 12, select(math.random(1, 5), 0, 4, 5, 7, 12), 0) -- legs
        ped.set_ped_component_variation(mp_ped, 6, 99, math.random(0, 23), 0) -- feet
    end
end
