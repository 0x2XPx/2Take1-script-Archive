Fun menu + Troll menu v1.0.1

Installtion guide: 

Choose a version you wanna use (latest version is recommended (v.0.5.0).
...
Then just take everything from "Fun Menu v0.*.*" and drop it into your scripts folder.
