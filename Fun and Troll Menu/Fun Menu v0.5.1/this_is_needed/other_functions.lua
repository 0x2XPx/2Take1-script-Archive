...
function rainbowRGB(speed) --Absolutely skidded from noob#9000
	speed = speed * 0.25
	local d = utils.time_ms() / 1000
	local r = math.floor(math.sin(d * speed + 0) * 127 + 128)
	local g = math.floor(math.sin(d * speed + 2) * 127 + 128)
	local b = math.floor(math.sin(d * speed + 4) * 127 + 128)
	return r, g, b
end
