...
function extraFaceFeatures(mp_ped)
    ...
    ped.set_ped_face_feature(mp_ped, 0, xyz[math.random(1, #xyz)]) -- nose width
    ped.set_ped_face_feature(mp_ped, 1, xyz[math.random(1, #xyz)]) -- nose height
    ped.set_ped_face_feature(mp_ped, 2, xyz[math.random(1, #xyz)]) -- nose length
    ped.set_ped_face_feature(mp_ped, 3, xyz[math.random(1, #xyz)]) -- nose bridge
    ped.set_ped_face_feature(mp_ped, 4, xyz[math.random(1, #xyz)]) -- nose tip
    ped.set_ped_face_feature(mp_ped, 5, xyz[math.random(1, #xyz)]) -- nose bridge shaft

    ped.set_ped_face_feature(mp_ped, 6, xyz[math.random(1, #xyz)]) -- brow height
    ped.set_ped_face_feature(mp_ped, 7, xyz[math.random(1, #xyz)]) -- brow width
    ped.set_ped_face_feature(mp_ped, 8, xyz[math.random(1, #xyz)]) -- cheekbone height
    ped.set_ped_face_feature(mp_ped, 9, xyz[math.random(1, #xyz)]) -- cheekbone width
    ped.set_ped_face_feature(mp_ped, 10, xyz[math.random(1, #xyz)]) -- cheek width

    ped.set_ped_face_feature(mp_ped, 11, xyz[math.random(1, #xyz)]) -- eyelids
    ped.set_ped_face_feature(mp_ped, 12, xyz[math.random(1, #xyz)]) -- lips
    ped.set_ped_face_feature(mp_ped, 13, xyz[math.random(1, #xyz)]) -- jaw width
    ped.set_ped_face_feature(mp_ped, 14, xyz[math.random(1, #xyz)]) -- jaw height

    ped.set_ped_face_feature(mp_ped, 15, xyz[math.random(1, #xyz)]) -- chin length
    ped.set_ped_face_feature(mp_ped, 16, xyz[math.random(1, #xyz)]) -- chin position
    ped.set_ped_face_feature(mp_ped, 17, xyz[math.random(1, #xyz)]) -- chin width
    ped.set_ped_face_feature(mp_ped, 18, xyz[math.random(1, #xyz)]) -- chin shape
    ped.set_ped_face_feature(mp_ped, 19, xyz[math.random(1, #xyz)]) -- neck width
end

function evenMoreExtraFeatures(player_ped)
    local xyz = {0.9, 0.7, 0.9, 0.0, 0.1, 0.1, 0.4, 0.8, 0.2, 0.0, 0.8, 0.3, 0.4, 0.8, 0.7, 0.3, 0.1, 0.3, 0.5, 0.5, 0.6, 1.0, 0.6, 0.5, 1.0, 0.4, 0.7, 0.9, 0.0, 0.6, 0.2, 0.2, 1.0}
    ped.set_ped_head_overlay(player_ped, 0, math.random(-1, 23), xyz[math.random(1, #xyz)]) -- Blemishes
    ped.set_ped_head_overlay(player_ped, 7, math.random(-1, 10), xyz[math.random(1, #xyz)]) -- Sun Damage
    ped.set_ped_head_overlay(player_ped, 9, math.random(-1, 17), xyz[math.random(1, #xyz)]) -- Freckles
    ped.set_ped_head_overlay(player_ped, 11, math.random(-1, 11), xyz[math.random(1, #xyz)]) -- Body Blemishes
end
...
function addBlip(clone_ped, blip_id)
    local blippy = ui.add_blip_for_entity(clone_ped)
    ui.set_blip_sprite(blippy, blip_id)
end
...
function animalAI(animal, player_id, anim_dict, anim_string, toggle)
    ...
    network.request_control_of_entity(animal)
