-- Lib weapon_mapper version: 1.0.1
-- Made by Kektram

-- Attachments
	local weapon_attachments = {}

	weapon_attachments[gameplay.get_hash_key("weapon_knuckle")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_switchblade")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_pistol")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_combatpistol")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_appistol")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_pistol50")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_revolver")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_snspistol")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_heavypistol")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_revolver_mk2")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_snspistol_mk2")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_pistol_mk2")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_vintagepistol")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_raypistol")] = 
		{
			{"Festive tint", "COMPONENT_RAYPISTOL_VARMOD_XMAS18", 0xD7DBF707}
		}


	weapon_attachments[gameplay.get_hash_key("weapon_ceramicpistol")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_microsmg")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_smg")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_assaultsmg")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_minismg")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_smg_mk2")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_machinepistol")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_combatpdw")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_pumpshotgun")] = 
		{
			{"Flashlight", "COMPONENT_AT_AR_FLSH", 0x7BC4CDDC},
	...
	weapon_attachments[gameplay.get_hash_key("weapon_sawnoffshotgun")] = 
		{
			{"Gilded Gun Metal Finish", "COMPONENT_SAWNOFFSHOTGUN_VARMOD_LUXE", 0x85A64DF9}
		}


	weapon_attachments[gameplay.get_hash_key("weapon_assaultshotgun")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_bullpupshotgun")] = 
		{
			{"Flashlight", "COMPONENT_AT_AR_FLSH", 0x7BC4CDDC},
			{"Suppressor Muzzle Brake", "COMPONENT_AT_AR_SUPP_02", 0xA73D4664},
			{"Grip", "COMPONENT_AT_AR_AFGRIP", 0xC164F53}
	...
	weapon_attachments[gameplay.get_hash_key("weapon_pumpshotgun_mk2")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_heavyshotgun")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_combatshotgun")] = 
		{
			{"Flashlight", "COMPONENT_AT_AR_FLSH", 0x7BC4CDDC},
			{"Suppressor Muzzle Brake", "COMPONENT_AT_AR_SUPP", 0x837445AA}
		}
	...
	weapon_attachments[gameplay.get_hash_key("weapon_assaultrifle")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_carbinerifle")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_advancedrifle")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_specialcarbine")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_bullpuprifle")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_bullpuprifle_mk2")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_specialcarbine_mk2")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_assaultrifle_mk2")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_carbinerifle_mk2")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_compactrifle")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_militaryrifle")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_mg")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_combatmg")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_combatmg_mk2")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_gusenberg")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_sniperrifle")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_heavysniper")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_marksmanrifle_mk2")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_heavysniper_mk2")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_marksmanrifle")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_grenadelauncher")] = 
		{
	...
	weapon_attachments[gameplay.get_hash_key("weapon_grenadelauncher_smoke")] = 
		{
			{"Default Clip", "COMPONENT_GRENADELAUNCHER_CLIP_01", 0x11AE5C97},
			{"Flashlight", "COMPONENT_AT_AR_FLSH", 0x7BC4CDDC},
			{"Grip", "COMPONENT_AT_AR_AFGRIP", 0xC164F53},
...
local kek_weapon_mapper = {}

local function get_hashes(t)
	local hashes = {}
	for i = 1, #t do
		hashes[i] = t[i][2]
	end
...
function kek_weapon_mapper.get_table_of_melee_weapons()
	return get_hashes(melee_weapons)
end

function kek_weapon_mapper.get_table_of_rifles()
	return get_hashes(rifles)
end

function kek_weapon_mapper.get_table_of_smgs()
	return get_hashes(SMGs)
end

function kek_weapon_mapper.get_table_of_explosive_weapons()
	return get_hashes(explosive_weapons)
end

function kek_weapon_mapper.get_table_of_shotguns()
	return get_hashes(shotguns)
end

function kek_weapon_mapper.get_table_of_misc_weapons()
	return get_hashes(misc)
end

function kek_weapon_mapper.get_table_of_throwables()
	return get_hashes(throwables)
end

function kek_weapon_mapper.get_table_of_pistols()
	return get_hashes(pistols)
end

function kek_weapon_mapper.get_table_of_heavy_weapons()
	return get_hashes(heavy_weapons)
end

function kek_weapon_mapper.get_all_attachment_info_for_weapon(weapon_hash)
...
function kek_weapon_mapper.get_weapon_attachment_details(weapon_hash)
	if weapon_attachments[weapon_hash] then
		return weapon_attachments[weapon_hash]
	else
		return {}
...
function kek_weapon_mapper.get_all_weapon_attachment_details()
	return weapon_attachments
end

function kek_weapon_mapper.get_maxed_attachments_for_weapon(weapon_hash)
	if weapon_attachments[weapon_hash] then
		local attachments = {}
		for i, attachment in pairs(weapon_attachments[weapon_hash]) do
			for p, attachment_type in pairs(attachment_types) do
				if attachment[attachment_type[2]]:lower():find(attachment_type[1]) then
...
function kek_weapon_mapper.get_random_attachments_for_weapon(weapon_hash)
	if weapon_attachments[weapon_hash] then
		local attachments = {}
