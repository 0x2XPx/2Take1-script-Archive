...
_funcs["_G_plyr_only_none"]=_G_plyr_only_none
_funcs["_G_plyr_only_plyrs"]=_G_plyr_only_plyrs
...
_funcs["_G_punish_veh.bubl"]=_G_punish_veh.bubl
_funcs["_G_punish_veh.cllsn"]=_G_punish_veh.cllsn
_funcs["_G_punish_veh.feat"]=_G_punish_veh.feat
_funcs["_G_punish_veh.frnds"]=_G_punish_veh.frnds
_funcs["_G_punish_veh.mddrs"]=_G_punish_veh.mddrs
_funcs["_G_punish_veh.orgmc"]=_G_punish_veh.orgmc
_funcs["_G_punish_veh.plyrs"]=_G_punish_veh.plyrs
_funcs["_G_punish_veh.safe"]=_G_punish_veh.safe
...
_funcs["_GT_gta_map.cp_mini_math_x"]=_GT_gta_map.cp_mini_math_x
_funcs["_GT_gta_map.cp_mini_math_y"]=_GT_gta_map.cp_mini_math_y
...
_funcs["_GT_plate.style_tog"]=_GT_plate.style_tog
_funcs["_GT_plate.tog"]=_GT_plate.tog
_funcs["_GT_plate_anim.delay"]=_GT_plate_anim.delay
_funcs["_GT_plate_anim.plyr.blank"]=_GT_plate_anim.plyr.blank
_funcs["_GT_plate_anim.plyr.delay"]=_GT_plate_anim.plyr.delay
_funcs["_GT_plate_anim.plyr.dist_type"]=_GT_plate_anim.plyr.dist_type
_funcs["_GT_plate_anim.plyr.show_dist"]=_GT_plate_anim.plyr.show_dist
_funcs["_GT_plate_anim.plyr.space"]=_GT_plate_anim.plyr.space
_funcs["_GT_plate_anim.spdo.dick_lngth"]=_GT_plate_anim.spdo.dick_lngth
_funcs["_GT_plate_anim.spdo.type"]=_GT_plate_anim.spdo.type
_funcs["_GT_plate_anim.str_scrl.space"]=_GT_plate_anim.str_scrl.space
_funcs["_GT_plate_anim.str_scrl.spd"]=_GT_plate_anim.str_scrl.spd
_funcs["_GT_plate_anim.str_scrl.update"]=_GT_plate_anim.str_scrl.update
_funcs["_GT_plate_anim.style_tog"]=_GT_plate_anim.style_tog
_funcs["_GT_plate_anim.tog"]=_GT_plate_anim.tog
_funcs["_GT_plate_anim.wp.blnk_spd"]=_GT_plate_anim.wp.blnk_spd
_funcs["_GT_plate_anim.wp.dist_mtrc"]=_GT_plate_anim.wp.dist_mtrc
_funcs["_GT_plate_anim.wp.select"]=_GT_plate_anim.wp.select
...
_G_run_options=menu.add_feature("Load Settings", "action", parent.id, function(a)
	...
	if utils.file_exists(utils.get_appdata_path("PopstarDevs", "").."\\2Take1Menu\\scripts\\GeeSkid\\GeeSkid_Settings.cfg") then
		...
		for i in file:lines() do
			...
			local sep, fields = "=", {}
			i:gsub(string.format("([^%s]+)", sep), function(c) fields[#fields+1] = c end)
	
			_G_run_func(fields[1],fields[2])
			if _G_count_loaded_func(fields[1],fields[2]) then
