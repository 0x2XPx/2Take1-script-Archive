...
function _GF_mean_ped(_ped)
	return (native.call(0x9E6B70061662AE5C,ped.get_ped_relationship_group_hash(player.get_player_ped(player.player_id())),ped.get_ped_relationship_group_hash(_ped)):__tointeger() == 5 or native.call(0x9E6B70061662AE5C,ped.get_ped_relationship_group_hash(player.get_player_ped(player.player_id())),ped.get_ped_relationship_group_hash(_ped)):__tointeger() == 4)
end

function _GF_nice_ped(_ped)
	return (native.call(0x9E6B70061662AE5C,ped.get_ped_relationship_group_hash(player.get_player_ped(player.player_id())),ped.get_ped_relationship_group_hash(_ped)):__tointeger() == 0 or native.call(0x9E6B70061662AE5C,ped.get_ped_relationship_group_hash(player.get_player_ped(player.player_id())),ped.get_ped_relationship_group_hash(_ped)):__tointeger() == 1 or native.call(0x9E6B70061662AE5C,ped.get_ped_relationship_group_hash(player.get_player_ped(player.player_id())),ped.get_ped_relationship_group_hash(_ped)):__tointeger() == 2)
end

function _GF_ped_attack_me(_ped)
	return (native.call(0x18A3E9EE1297FD39,_ped):__tointeger() == player.get_player_ped(player.player_id()) or native.call(0x32C27A11307B01CC,_ped):__tointeger() == player.get_player_ped(player.player_id()))
end
