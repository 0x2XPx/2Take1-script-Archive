...
function player_func.is_player_rockstar_dev(pid)
	return text_func.to_boolean(natives.NETWORK_PLAYER_IS_ROCKSTAR_DEV(pid):__tointeger())
end

function player_func.is_player_cheater(pid)
	return text_func.to_boolean(natives.NETWORK_PLAYER_INDEX_IS_CHEATER(pid):__tointeger())
end
